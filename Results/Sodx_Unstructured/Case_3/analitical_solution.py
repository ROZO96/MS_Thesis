...
file_B = open('B_Scheme/snapshot_20.txt')
file_N = open('N_Scheme/snapshot_20.txt')
file_LDA = open('LDA_Scheme/snapshot_20.txt')
file_Bx = open('Bx_Scheme/snapshot_20.txt')
