...
public:
...
#ifdef RTY
		//SPECIFIC_ENERGY = PRESSURE/((GAMMA-1.0)*MASS_DENSITY) + VEL_SQ_SUM/2.0 + GRAV*Y ;
 ...
 #ifdef RTY
 		//PRESSURE =(GAMMA-1.0) * MASS_DENSITY * (SPECIFIC_ENERGY - VEL_SQ_SUM/2.0 - GRAV*Y);
 ...
 #ifdef RTY
 		//PRESSURE_HALF =(GAMMA-1.0) * MASS_DENSITY_HALF * (SPECIFIC_ENERGY_HALF -  VEL_SQ_SUM/2.0 - GRAV*Y);
 		//PRESSURE_HALF =(GAMMA-1.0) * MASS_DENSITY_HALF * (SPECIFIC_ENERGY_HALF -  VEL_SQ_SUM/2.0 - GRAV*abs(Y-Y_HALF));
 #endif
